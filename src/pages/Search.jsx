...
import biosampleWesternBeeCsvUrl from "../../biosample_western bee_final.csv?url";
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const response = await fetch(biosampleWesternBeeCsvUrl);
        if (!response.ok) {
        ...
        const csvData = XLSX.utils.sheet_to_json(worksheet, { defval: "" });
        setData(csvData);
      } catch (err) {
